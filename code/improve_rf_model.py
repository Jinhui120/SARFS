...
with open(model_path, 'wb') as file:
    pickle.dump(rf_model_optimized, file)
...
"""
1.优化后的 n_estimators 参数值: 123;优化后的 max_depth 参数值: 12
2.测试集评估 - acc: 0.9822, pre: 0.9816, rec: 0.9821, f1: 0.9818
"""

"""
1.现在已经选出最优的优化方法：SSA-RF
2.下一步工作是选用ETC、RF、SSA-RF做特征重要性排序和SHAP的可解释性分析
"""
